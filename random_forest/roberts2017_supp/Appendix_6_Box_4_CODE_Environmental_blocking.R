...
####   Jose J. Lahoz-Monfort, Boris Schr?der, Wilfried Thuiller,
...
load(here::here("random_forest", "Appendix_6_Box_4_DATA_NorthAmerica_DougFir.RData"))
...
dir.create(here::here("random_forest", "roberts2017_supp", "Models"))   # For models and model summaries
dir.create(here::here("random_forest", "roberts2017_supp", "CV"))       # For cross-validation results
dir.create(here::here("random_forest", "roberts2017_supp", "Plots"))    # Save plots here
